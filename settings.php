...
<tr><td>Username</td><td><?php if(empty($_POMK)) { echo '8728 (default)';}else{ ?><?php echo $_POMK;?><?php } ?></td></tr>
...
<tr>
<td class="align-middle">Username</td><td><input placeholder="Username Mikrotik" autocomplete="off" class="form-control" type="text" name="port" value="<?php if(isset($_POST['cek'])) { echo $port1;}else{ ?><?php echo $_POMK1;?><?php } ?>" required="1"/></td>
</tr>
<tr>
<td class="align-middle">Password</td><td><input placeholder="Password Mikrotik" autocomplete="off" class="form-control" type="password" name="user" value="<?php if(isset($_POST['cek'])) { echo $user1;}else{ ?><?php echo $_USMK1;?><?php } ?>" required="1"/></td>
</tr>
