...
$_ceklog = '<div class="alert alert-success alert-dismissible text-dark" role="alert">Username: '. $_USER.'<br/>Password: '. _de(ltrim($_PASS, __CMS)).'</div><p><a class="btn btn-sm" href="./?index=login">LOGIN</a></p>';
} else {
